...
Build a new native SwiftUI iOS app for Nostroots, using `nr-web` as the product and behavior source of truth. The app should live under `vibe/web/ios-app` and target iOS 17+ for TestFlight first.
...
Implemented in `vibe/web/ios-app`:
