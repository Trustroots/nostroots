    ...
    <>
      ...
      <ThemedView className="flex-1 items-center justify-center px-8 gap-6 bg-white">
        ...
        <ThemedText className="text-gray-600 text-center leading-relaxed">
          This is the experimental onboarding flow. Enable it via the
          settings feature flag to try a simpler, route-based onboarding
          experience.
        </ThemedText>

        <ThemedText className="text-gray-600 text-center leading-relaxed">
          When fully wired, this screen will guide new users through
          account setup, key management, and verification using the
          Nostroots and Trustroots ecosystem.
        </ThemedText>
