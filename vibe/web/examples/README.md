...
1. Copy `pixel.html` if you want a single-file demo pattern, or copy the relevant `<style>` and `<script>` blocks out of `web/index.html` into a new HTML file beside it.
