...
# The headless Google APIs image occasionally surfaces a Pixel Launcher ANR
# over the app. The launcher is not used by these deep-link driven flows, so
# stop it before Maestro starts instead of letting the system dialog mask every
# app assertion.
