...
exports.contentSchema = exports.tagsIncludingPlusCodeSchema = exports.baseEventSchema = exports.finalizedEventFields = exports.idSchema = exports.baseEventTemplateSchema = void 0;
...
exports.idSchema = deps_js_1.z.string().length(64);
