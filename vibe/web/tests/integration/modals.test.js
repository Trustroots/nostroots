...
describe('Modal Behavior', () => {
  ...
  describe('Settings Modal', () => {
    ...
    it('orders notifications first and keeps appearance before KPIs', () => {
      ...
      expect(sections.at(-2)?.querySelector('h2')?.textContent).toBe('Appearance');
      expect(sections.at(-1)?.querySelector('h2')?.textContent).toBe('Activity KPIs');
    });
  });
