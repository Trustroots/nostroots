...
export declare const NOSTR_USER_METADATA_KIND: 0;
...
export declare const SERVER_MESSAGE_KIND: 20398;
export declare const MAP_NOTE_KIND: 30397;
export declare const MAP_NOTE_REPOST_KIND: 30398;
export declare const THIRD_PARTY_EVENT_KIND: 30399;
export declare const ACCEPTED_KINDS: (0 | 5 | 10390 | 10395 | 20398 | 30397 | 30398 | 30399)[];
export declare const SERVER_MESSAGE_TYPE_TAG_NAME: "serverMessageType";
export declare const SERVER_MESSAGE_TYPES: readonly ["error", "info"];
...
export declare const AMQP_EXCHANGE_NAME: "nostrEvents";
export declare const AMQP_EXCHANGE_TYPE: "fanout";
export declare const AMQP_RELAY_INGEST_QUEUE_NAME: "repost";
export declare const DEFAULT_RELAY_URL = "wss://relay.trustroots.org";
export declare const NOTIFICATION_SERVER_PUBKEY: "62ab89bfb4f0e1f4f64653bfef77fcf4e9062cd9585a97d6b1f17ff953e4e032";
